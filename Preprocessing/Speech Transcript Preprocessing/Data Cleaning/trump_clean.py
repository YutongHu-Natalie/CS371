...
data = pd.read_csv('donald_trump_transcripts.csv')
print(data.info())
...
relevant_speakers = ["Donald Trump", "Trump", "Donald", "President Trump", "President Donald Trump"]
...
df_filtered2[['Transcript', 'cleaned']].info()

df_filtered2.to_csv('trump_transcripts_cleaned.csv', index=False)